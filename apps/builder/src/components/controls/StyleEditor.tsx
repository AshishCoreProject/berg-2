...
export function StyleEditor({ title, values, onChange, variant }: Props) {
  ...
  return (
    <div className="style-editor">
      ...
      {variant === "footer" ? (
        <div className="style-editor-footer-grid">
          ...
          <label className="style-editor-row">
            ...
            <div className="style-editor-color">
              ...
              <input
                ...
                value={values.color ?? ""}
                onChange={(e) =>
                  set("color", e.target.value.trim() || undefined)
                }
                placeholder="#ffffff"
                className="style-hex"
              />
        ...
        <>
          <div className="style-editor-leftbox">
            <label className="style-editor-row">
              <span>Background</span>
              <div className="style-editor-color">
                <input
          ...
          <div className="style-editor-rightbox">
        {variant === "header" && (
          <>
            <div
              className="style-editor-leftbox"
              style={{
                alignItems: "center",
              }}
            >
                ...
                <select
                  ...
                  onChange={(e) =>
                    set(
                      "titlePosition",
                      (e.target.value ||
                        "right") as StyleValues["titlePosition"],
                    )
                  }
              ...
              <label className="style-editor-row">
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="8px"
                    disabled={!values.logoUrl || values.showTitle === false}
                    style={{ flex: 1, maxWidth: "100px", textAlign: "center" }}
                  />
                  <button
                    type="button"
                    onClick={() => {
                ...
                <label className="style-editor-row">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setBoolean("showCartIcon", e.target.checked)
                      }
                    />
                    <span
                ...
                <label className="style-editor-row">
                  ...
                  <div className="style-editor-color">
                    <input
                      type="color"
                      value={
                        values.cartIconColor || values.linkColor || "#94a3b8"
                      }
                ...
                <label className="style-editor-row">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setBoolean("showAccountIcon", e.target.checked)
                      }
                    />
                    <span
                      style={{ fontSize: "0.75rem", color: "var(--muted)" }}
                ...
                <label className="style-editor-row">
                  ...
                  <div className="style-editor-color">
                    <input
                      type="color"
                      value={
                        values.accountIconColor || values.linkColor || "#94a3b8"
                      }
          ...
          <>
            <label className="style-editor-row">
              ...
              <input
                ...
                value={values.border ?? ""}
                onChange={(e) =>
                  set("border", e.target.value.trim() || undefined)
                }
            ...
            <label className="style-editor-row">
              ...
              <input
                ...
                onChange={(e) =>
                  set("boxShadow", e.target.value.trim() || undefined)
                }
