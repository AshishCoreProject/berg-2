...
function asLayoutSlice(raw: unknown): GridLayoutSlice | undefined {
...
): GridLayoutSlice | undefined {
  if (!attrs) return undefined;

  const byVp = attrs.layoutByViewport as Partial<Record<StorefrontViewport, unknown>> | undefined;
