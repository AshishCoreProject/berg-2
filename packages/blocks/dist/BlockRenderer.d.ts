...
export declare function BlockRenderer({ block, apiBaseUrl, useDemoData, renderChildren, layoutViewport }: Props): string | number | boolean | import("react/jsx-runtime").JSX.Element | Iterable<import("react").ReactNode> | null | undefined;
export {};
